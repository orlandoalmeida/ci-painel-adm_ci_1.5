                ...
                <div class="container">
                    ...
                    <div class="col-md-4">
                        <div class="card-box widget-box-three">
                            ...
                            <div class="text-right">
                                <p class="m-t-5 text-uppercase font-14 font-600"></p><br>
                                <input type="file" class="filestyle" data-input="false" tabindex="-1" data-buttontext="OG Image" name="config_og_image" style="position: absolute; clip: rect(0px 0px 0px 0px);">
                            </div>
                        </div>
                    </div>
